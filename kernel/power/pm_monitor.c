...
//svc_register_auto() in modem	ONCRPC_DAEMON_APIPROG_LOCAL 

	{ 0x30000000, "CM" },//check for 7x30 2030
	{ 0x30000001, "DB" },//check for 7x30 2030
	{ 0x30000002, "SND" },
	{ 0x30000003, "WMS" },//check for 7x30 2030
	{ 0x30000004, "PDSM" },
	...
	{ 0x3000000e, "NV" },//check for 7x30 2030
	{ 0x3000000f, "CLKRGM_SEC" },//check for 7x30 2030
	{ 0x30000010, "RDEVMAP" },//check for 7x30 2030
	{ 0x30000011, "FS_RAPI" },
	{ 0x30000012, "PBMLIB" },//check for 7x30 2030
	{ 0x30000013, "AUDMGR" },
	{ 0x30000014, "MVS" },
	{ 0x30000015, "DOG_KEEPALIVE" },//check for 7x30 2030
	{ 0x30000016, "GSDI_EXP" },//check for 7x30 2030
	{ 0x30000017, "AUTH" },//check for 7x30 2030
	{ 0x30000018, "NVRUIMI" },//check for 7x30 2030
	{ 0x30000019, "MMGSDILIB" },//check for 7x30 2030
	{ 0x3000001a, "CHARGER" },//check for 7x30 2030
	{ 0x3000001b, "UIM" },//check for 7x30 2030
	{ 0x3000001C, "ONCRPCTEST" },//check for 7x30 2030
	{ 0x3000001d, "PDSM_ATL" },//check for 7x30 2030
	{ 0x3000001e, "FS_XMOUNT" },
	{ 0x3000001f, "SECUTIL " },
	{ 0x30000020, "MCCMEID" },//check for 7x30 2030
	{ 0x30000021, "PM_STROBE_FLASH" },
	{ 0x30000022, "DS707_EXTIF" },
	{ 0x30000023, "SMD BRIDGE_MODEM" },
	{ 0x30000024, "SMD PORT_MGR" },//check for 7x30 2030
	{ 0x30000025, "BUS_PERF" },//check for 7x30 2030
	{ 0x30000026, "BUS_MON" },
	{ 0x30000027, "MC" },
	{ 0x30000028, "MCCAP" },
	{ 0x30000029, "MCCDMA" },//check for 7x30 2030
	{ 0x3000002a, "MCCDS" },
	{ 0x3000002b, "MCCSCH" },
	{ 0x3000002c, "MCCSRID" },
	{ 0x3000002d, "SNM" },
	...
	{ 0x30000037, "HDRMC_APIS" },//check for 7x30 2030
	{ 0x30000038, "SMD_BRIDGE_APPS" },//change
	{ 0x30000039, "SMD_BRIDGE_ATOM" },
	{ 0x3000003a, "DPMAPP_OTG" },
	{ 0x3000003b, "DIAG" },//check for 7x30 2030
	{ 0x3000003c, "GSTK_EXP" },//check for 7x30 2030
	...
	{ 0x30000044, "CMIPAPP" },//check for 7x30 2030
	{ 0x30000045, "DSMP_UMTS_MODEM_APIS" },
	{ 0x30000046, "DSMP_UMTS_APPS_APIS" },
	{ 0x30000047, "DSUCSDMPSHIM" },
	{ 0x30000048, "TIME_REMOTE_ATOM" },//check for 7x30 2030
	{ 0x3000004a, "SD" },//check for 7x30 2030
	{ 0x3000004b, "MMOC" },//check for 7x30 2030
	...
	{ 0x3000005b, "PDAPI" },//check for 7x30 2030
	{ 0x3000005c, "LSA_SUPL_DSM" },
	{ 0x3000005d, "TIME_REMOTE_MTOA" },
	{ 0x3000005e, "FTM_BT" },
	{ 0X3000005f, "DSUCSDAPPIF_APIS" },//check for 7x30 2030
	{ 0X30000060, "PMAPP_GEN" },//check for 7x30 2030
	{ 0X30000061, "PM_LIB" },//check for 7x30 2030
	{ 0X30000062, "KEYPAD" },
	{ 0X30000063, "HSU_APP_APIS" },//check for 7x30 2030
	{ 0X30000064, "HSU_MDM_APIS" },//check for 7x30 2030
	{ 0X30000065, "ADIE_ADC_REMOTE_ATOM " },
	{ 0X30000066, "TLMM_REMOTE_ATOM" },
	{ 0X30000067, "UI_CALLCTRL" },
	{ 0X30000068, "UIUTILS" },
	{ 0X30000069, "PRL" },//check for 7x30 2030
	{ 0X3000006a, "HW" },
	{ 0X3000006b, "OEM_RAPI" },//check for 7x30 2030
	{ 0X3000006c, "WMSPM" },
	{ 0X3000006d, "BTPF" },
	...
	{ 0X30000074, "DSATAPI" },//check for 7x30 2030
	...
	{ 0X30000081, "PING_MDM_RPC" },//check for 7x30 2030
	{ 0X30000082, "PING_APPSPROG" },
	{ 0X30000083, "TIMETICK" },
	...
	{ 0X30000088, "CMIPSMS " },
	{ 0X30000089, "VBATT_REMOTE" },//check for 7x30 2030
	{ 0X3000008a, "MFPAL" },
	{ 0X3000008b, "DSUMTSPDPREG" },//check for 7x30 2030
	{ 0x3000008c, "LOC_APIPROG" },//new for 7x30 2030
	{ 0x3000008f, "ISENSEPROG" },//new for 7x30 2030
	{ 0x30000091, "HS KEYPAD" },//new for 7x30 2030
	{ 0x30000093, "NETPROG" },//new for 7x30 2030
	{ 0x3000009b, "TEST_API" },//new for 7x30 2030
	{ 0x3000009c, "REMOTEFS_SRV_API" },//new for 7x30 2030
	{ 0x3000009f, "TOUCH_SCREEN_ADC" },//new for 7x30 2030
	{ 0x300000a1, "SMD_BRIDGE_MODEM" },//new for 7x30 2030
	{ 0x300000a2, "DOG_KEEPALIVE_MODEMPROG" },//new for 7x30 2030
	{ 0x300000a4, "NPA_REMOTE" },//new for 7x30 2030
	{ 0x300000a5, "MMGSDISESSIONLIB" },//new for 7x30 2030
	{ 0x300000a7, "REMOTE_STORAGEPROG" },//new for 7x30 2030
	{ 0x300000ab, "FM_WAN_APIPROG" },//new for 7x30 2030
	{ 0x300000b1, "GPSONE_BIT_APIPROG" },//new for 7x30 2030
	...
	{ 0x31000038, "SMD_BRIDGE_APPSCBPROG CB" },
	...
	{ 0X3100008c, "LOC_APICB" },
	{ 0X3100008f, "ISENSECB" },
	{ 0x31000091, "HS_REMCB KEYPAD" },
	{ 0x3100009b, "TEST_APICBPROG" },
	{ 0x3100009c, "REMOTEFS_SRV_APICB" },
	{ 0x310000a1, "SMD_BRIDGE_MODEMCBPROG" },
	{ 0x310000a2, "DOG_KEEPALIVE" },
	{ 0x310000a5, "MMGSDISESSIONLIBCB" },
	{ 0x310000a7, "REMOTE_STORAGE" },
	{ 0x310000ab, "FM_WAN_APICB" },
	{ 0x310000b1, "GPSONE_BIT_APICB" },
