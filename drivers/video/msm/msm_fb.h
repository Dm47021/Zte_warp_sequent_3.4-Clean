...
{
	LCD_PANEL_NONE = 0,
        LCD_PANEL_LEAD_WVGA, //arthur
	LCD_PANEL_TRULY_WVGA, //arthur
	LCD_PANEL_BOE_WVGA, //arthur
	LCD_PANEL_TFT_LEAD_RM68120, //arthur
	LCD_PANEL_HX8369_TIANMA_WVGA,
