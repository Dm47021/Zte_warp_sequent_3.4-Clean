...
#define SENSOR_INFO_MT9D115_MODEL_ID    0x2580
#define SENSOR_INFO_MT9D113_MODEL_ID    0x0003
#define SENSOR_INFO_MT9D114_MODEL_ID    0x2481
...
#define SENSOR_INFO_OV2675_MODEL_ID     0x2656
#define SENSOR_INFO_OV9740_MODEL_ID     0x9740
#define SENSOR_INFO_T8EV5_MODEL_ID       0x1011 
    ...
    switch(g_sensor_id)
    {
       ...
       case SENSOR_INFO_0X5CA_MODEL_ID:
    	...
    	case SENSOR_INFO_OV2675_MODEL_ID:
            ...
            break;
	case SENSOR_INFO_T8EV5_MODEL_ID:
	     sprintf(sensor_name, "T8EV5-5.0Mp-AF");
            break;
        default:
                                            ...
                                            char *buf)
{
    ...
    switch(g_front_sensor_id)
    {
        ...
        case SENSOR_INFO_MT9D113_MODEL_ID:
            sprintf(sensor_name, "MT9D113-2.0Mp-FF");
            break;
	 case SENSOR_INFO_MT9D114_MODEL_ID:
            sprintf(sensor_name, "MT9D114-1.0Mp-FF");
            break;
       case SENSOR_INFO_OV5640_MODEL_ID:
            sprintf(sensor_name, "OV5640-5.0Mp-AF");
            break;
...
DEFINE_SEMAPHORE(set_sensor_id_sem);
