...
//Hector 20120904 add for porting bcm4330 driver 5.90.195.89+++
//u32 wl_dbg_level = WL_DBG_ERR;
u32 wl_dbg_level = WL_DBG_ERR | WL_DBG_DBG | WL_DBG_TRACE | WL_DBG_SCAN | WL_DBG_INFO;
//Hector 20120904 add for porting bcm4330 driver 5.90.195.89---
...
//Hector 20121022 add for open softap max client bug+++
			/* find the max_assoc */
...
//Hector 20121022 add for open softap max client bug---
			...
			if (closed){
				...
				//}
				char buff[64];
				bcm_mkiovar("closednet", (char *)(&closed), sizeof(closed), buff, 64);
				wldev_ioctl(dev, WLC_SET_VAR, buff, 64, true);
			}
