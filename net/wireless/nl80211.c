...
{
	printk("shaohua test cipher = %08x\n", cipher);
...
//Maybe it will infrent the WAPI	
                for (i = 0; i < 1; i++)
		//for (i = 0; i < settings->n_ciphers_pairwise; i++)
...
printk("shaohua test 3\n");
	}
printk("shaohua exit %s\n", __func__);
	return 0;
}
