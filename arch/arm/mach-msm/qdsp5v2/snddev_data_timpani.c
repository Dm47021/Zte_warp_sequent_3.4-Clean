...
#if 1
static struct adie_codec_action_unit ihac_ffa_48KHz_osr256_actions[] =
	HAC_PRI_MONO_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry ihac_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihac_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihac_ffa_48KHz_osr256_actions),
	}
};
...
static enum hsed_controller imic_pmctl_id[] = {PM_HSED_CONTROLLER_1};
...
// BCM FM, begin
// BCM FM headset
static struct adie_codec_action_unit fm_headset_ab_cpls_48KHz_osr256_actions[] =
	FM_HEADSET_AB_CPLS_48000_OSR_256;

static struct adie_codec_hwsetting_entry fm_headset_ab_cpls_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = fm_headset_ab_cpls_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(fm_headset_ab_cpls_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile fm_headset_ab_cpls_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = fm_headset_ab_cpls_settings,
	.setting_sz = ARRAY_SIZE(fm_headset_ab_cpls_settings),
};

static struct snddev_icodec_data snddev_fm_hs_rx_data = {
	.capability = SNDDEV_CAP_RX,
	.name = "fmradio_headset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_STEREO, /* PSEUDO_ACDB_ID, Reduce Gain of Music Playback */
	.profile = &fm_headset_ab_cpls_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_bcm_fm_headset_device = {
	.name = "snddev_icodec",
	.id = 9,
	.dev = { .platform_data = &snddev_fm_hs_rx_data },
};

// BCM FM speaker
static struct adie_codec_action_unit fm_spkr_stereo_48KHz_osr256_actions[] =
	FM_SPEAKER_PRI_STEREO_48000_OSR_256;

static struct adie_codec_hwsetting_entry fm_spkr_stereo_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = fm_spkr_stereo_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(fm_spkr_stereo_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile fm_spkr_stereo_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = fm_spkr_stereo_settings,
	.setting_sz = ARRAY_SIZE(fm_spkr_stereo_settings),
};

static struct snddev_icodec_data snddev_fm_spkr_stereo_data = {
	.capability = SNDDEV_CAP_RX,
	.name = "fmradio_speaker_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_STEREO, /* PSEUDO_ACDB_ID, Reduce Gain of Music Playback */
	.profile = &fm_spkr_stereo_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_bcm_fm_speaker_device = {
	.name = "snddev_icodec",
	.id = 10,
	.dev = { .platform_data = &snddev_fm_spkr_stereo_data },
};
// BCM FM, end
...
static struct adie_codec_hwsetting_entry imic_spkr_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_spkr_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_spkr_48KHz_osr256_actions),
	}
};


static struct adie_codec_dev_profile imic_spkr_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_spkr_settings,
	.setting_sz = ARRAY_SIZE(imic_spkr_settings),
};
...
static enum hsed_controller ispk_aux_pmctl_id[] = {PM_HSED_CONTROLLER_1};
