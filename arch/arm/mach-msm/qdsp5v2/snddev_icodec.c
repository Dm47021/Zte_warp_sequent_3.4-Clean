...
#ifdef CONFIG_MACH_BLADEPLUS
	//enable HSED_MIC_BIAS1
	if(icodec->data->acdb_id == ACDB_ID_HANDSET_MIC_ENDFIRE ||
           icodec->data->acdb_id == ACDB_ID_SPKR_PHONE_MIC_ENDFIRE ||
	   icodec->data->acdb_id == ACDB_ID_SPKR_PHONE_MIC ){
		msm_snddev_enable_cmic_power();
	}
#endif
...
#ifdef CONFIG_MACH_BLADEPLUS
	//disable HSED_MIC_BIAS1
	if(icodec->data->acdb_id == ACDB_ID_HANDSET_MIC_ENDFIRE ||
           icodec->data->acdb_id == ACDB_ID_SPKR_PHONE_MIC_ENDFIRE ||
	   icodec->data->acdb_id == ACDB_ID_SPKR_PHONE_MIC ){
		msm_snddev_disable_cmic_power();
	}
#endif
